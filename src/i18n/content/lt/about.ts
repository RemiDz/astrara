import type { AboutContent } from '../en/about'
...
export const aboutContent: AboutContent = {
  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        'Palietus garso piktogram\u0105, Astrara generuoja gyv\u0105 aplinkos garsovaid\u012F, suderint\u0105 su \u0161iandienos planetine konfig\u016Bracija. Tai n\u0117ra i\u0161 anksto \u012Fra\u0161yta muzika \u2014 tai sukuriama realiu laiku j\u016Bs\u0173 \u012Frenginio.',
    ...
    },
    {
      ...
      paragraphs: [
        'Palietus \u017Dem\u0119 rato centre, matote gyvus duomenis apie m\u016Bs\u0173 planetos elektromagnetin\u0119 aplink\u0105, tiesiogiai i\u0161 NOAA (JAV Nacionalin\u0117s vandenyng\u0173 ir atmosferos administracijos) palydov\u0173.',
  ...
  faq: {
    ...
    items: [
      ...
      },
      {
        ...
        a: 'Dronas ir planet\u0173 tonai veikia per garsiakalb\u012Fius, bet binauri\u0173 ritm\u0173 efektas veikia tik su ausin\u0117mis. Kai du \u0161iek tiek skirtingi da\u017Eniai grojami atskirose ausyse, j\u016Bs\u0173 smegenys sukuria ritm\u0105 \u2014 tai negali \u012Fvykti per garsiakalb\u012Fius, kur abi ausys girdi visk\u0105.',
      },
      {
      ...
      },
      {
        ...
        a: 'Ne. Astrara nerenka asmeni\u0173 duomen\u0173. J\u016Bs\u0173 vieta naudojama tik vietiniam laikui rodyti ir niekada nesiun\u010Diama jokiam serveriui. Jei \u012Fvedate gimimo duomenis, jie saugomi tik j\u016Bs\u0173 \u012Frenginyje. Naudojame Plausible Analytics, kuris orientuotas \u012F privatum\u0105 ir nenaudoja slapuk\u0173.',
      },
      {
        q: 'Kas tai suk\u016Br\u0117?',
        a: 'Astrara yra Harmonic Waves ekosistemos dalis \u2014 nemokam\u0173 \u012Frankli\u0173 rinkinys, sukurtas garso terapijos praktikams ir visiems, besidomintiems kosmini\u0173 ritm\u0173 ir \u017Emogi\u0161kos patirties ry\u0161iu. Su\u017Einokite daugiau harmonicwaves.app.',
      },
    ],
  },
  links: [
    { label: 'Atrask vis\u0105 ekosistem\u0105', url: 'https://harmonicwaves.app' },
    { label: '\u017Dem\u0117s Pulsas giliau', url: 'https://shumann.app' },
    { label: 'Binauriniai ritmai', url: 'https://binara.app' },
  ],
  version: 'v2.0',
}
